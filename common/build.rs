    ...
    for proto_file in &proto_files {
        ...
        if *proto_file == "messages.proto" {
            config = config
                ...
                .type_attribute(".messages.MarkMessagesAsReadResponse", "#[derive(serde::Serialize, serde::Deserialize)]")
                .type_attribute(".messages.RevokeMessageResponse", "#[derive(serde::Serialize, serde::Deserialize)]")
                .type_attribute(".messages.GetMessageHistoryResponse", "#[derive(serde::Serialize, serde::Deserialize)]")
                .type_attribute(".messages.GetConversationsResponse", "#[derive(serde::Serialize, serde::Deserialize)]")
                .type_attribute(".messages.DeleteMessagesResponse", "#[derive(serde::Serialize, serde::Deserialize)]")
                .type_attribute(".messages.ForwardMessageResponse", "#[derive(serde::Serialize, serde::Deserialize)]")
                .type_attribute(".messages.ReplyMessageResponse", "#[derive(serde::Serialize, serde::Deserialize)]")
                .type_attribute(".messages.Conversation", "#[derive(serde::Serialize, serde::Deserialize)]")
